...
export default function DashboardPage() {
  ...
  if (loading) {
    return <ThemeProvider familyTheme={familyTheme}><PageShell><main className="flex items-center justify-center min-h-[60vh]"><div className="text-ink/60 font-bold">Loading...</div></main></PageShell></ThemeProvider>;
  }
