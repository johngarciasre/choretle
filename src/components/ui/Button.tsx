...
type Variant = "primary" | "success" | "grape" | "indigo" | "ghost" | "danger" | "warning";
type Size = "sm" | "md" | "lg";
...
export function Button({
  ...
  const variantStyles: Record<Variant, string> = {
    ...
    indigo: "bg-indigo text-white shadow-md shadow-indigo/30 hover:-translate-y-0.5 hover:brightness-105",
