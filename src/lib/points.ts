 ...
 */
export function calculatePoints(job: any, subtasks?: any[]): number {
 ...
 */
export function shouldGenerateList(slate: any, targetDate: Date): boolean {
 ...
 */
export function findActiveSlatesForDate(slates: any[], targetDate: Date): any[] {
